module.exports = {
    methods: {
        ...
        initSelectFilters: require('../methods/init-select-filters'),
        showEditRow: require('../methods/show-edit-row'),
        isEditingRow: require('../methods/is-editing-row'),
        edit: require('../methods/edit-row'),
        cancelEdit: require('../methods/cancel-edit'),
        checkRow: require('../methods/check-row'),
        isChecked: require('../methods/is-checked')
    }
}
